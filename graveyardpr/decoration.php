...
if (isset($_POST['submit'])) {
  ...
  $pricedecor=$_SESSION["decorprice"];
 ...
 echo "<p align='left'> <font color=blue  size='6pt'>user name is  $username <br> age is  $Age <br> Time is  $Time <br> phone is  $Phone <br> address is  $Address <br>  ";
  ...
  // echo "hello";
  $sql = "INSERT INTO `order`.`decorations`(`Name`, `Age`, `Date`, `Phone number`, `Address`,`Religion`,`price`) 
        VALUES ('$username','$Age', '$Time','$Phone','$Address','$Religion','$pricedecor' );";
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 text-center">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <h1 class="text-white text-uppercase ">Decoration form</h1>
                        <h4 class="text-white text-uppercase">Standard marbel grave</h4>
                        <form action="decoration.php" method="post">
                          ...
                          <button class="w-100 btn btn-danger"><input type="submit" class=" btn btn-red text-white" name="submit" value="submit" /></button>  
