...
if (isset($_POST['submit'])) {
  ...
  $priceorder=$_SESSION["oprice"];
$_SESSION["phoneforpricegbooking"]=$Phone;
 ...
 echo "<p align='left'> <font color=blue  size='6pt'>user name is  $username <br> age is  $Age <br> Time is  $Time <br> phone is  $Phone <br> address is  $Address <br>  ";
  ...
  // echo "hello";
  $sql = "INSERT INTO `order`.`bookgrave`(`Name`, `Age`, `Date`, `Phonenumber`, `Address`,`Religion`,`price`) 
        VALUES ('$username','$Age', '$Time','$Phone','$Address','$Religion','$priceorder' );";

if ($conn->query($sql)) {
    // redirect first
    header("Location:http://localhost/pr/payment_details.php");
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 text-center">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <h1 class="mb-4 text-uppercase text-white">Deceased Info form</h1>
                         
                        <form action="BookGraves.php" method="post">
                        ...
                        <button class="btn btn-danger w-100"> <input type="submit" class="btn btn-danger" name="submit" value="submit" /></button>
