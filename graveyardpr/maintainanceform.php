...
if (isset($_POST['submit'])) {
 ...
 echo "<p align='left'> <font color=blue  size='6pt'>user name is  $username <br> age is  $Age <br> Time is  $Time <br> phone is  $Phone <br> address is  $Address <br>  ";
  ...
  // echo "hello";
  $sql = "INSERT INTO `order`.`maintainanceorder`(`Name`, `Age`, `Date`, `Phone number`, `Address`,`Religion`,`price`) 
        VALUES ('$username','$Age', '$Time','$Phone','$Address','$Religion','$mtnpriceorder' );";
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 text-center">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <h2 class="mt-3 mb-3 text-white text-uppercase">maintainance booking form</h2>
                        <form action="maintainanceform.php" method="post">
