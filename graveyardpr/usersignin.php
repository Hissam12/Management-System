...
if (isset($_POST['email'])) {
 ...
 $_SESSION["semail"] = $email;
  ...
  $sql = "SELECT `password` FROM `registeration`.`user` WHERE `email` LIKE '$email';"; //aal tuples in $query
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="usersignin.php" method="post">
                            ...
                            <div class="mt-3">
                                ...
                                <span class="psw"> <a
                                        href="http://localhost/pr/resetpassword.php" class="text-decoration-none text-white">Forgot password?</a></span>
                            </div>
                        </div>
