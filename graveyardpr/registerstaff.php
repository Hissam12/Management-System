...
if (isset($_POST['signup_submit'])) {
  ...
  // echo "hello";
  $sql = "INSERT INTO `registeration`.`staffadmin`(`sno`, `email`, `password`, `date`) 
        VALUES (NULL,'$email', '$psw', CURRENT_TIMESTAMP());";
            ...
            <div class="col-lg-6 col-md-12  mt-5 ">
                <div class="row  my-auto">
                    <div class="login mb-3">
                        <h2 class="text-white text-uppercase text-center">Welcome to graveyard managemant system staff registration page
                            </h2>
                    </div>
