...
<body>
    ...
    <form action="searchgravedetailsname.php" method="POST">
        <label for="search">Search by name  :</label>
        <input type="text" id="search" name="searchbyname">
    ...
    <table>
        ...
        <tbody>
            ...
            if (isset($_POST['Search'])) {
                ...
                $sql = "SELECT * FROM `grave`.`gravedetails` WHERE `Name` LIKE '$searchname' ";
