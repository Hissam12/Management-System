...
$religion = $_POST['religion'];
  ...
  $sql = "UPDATE `order`.`bookgrave` SET `Name`='$name', `Age`='$age', `Date`='$date',`Phonenumber`='$phone_number', `Address`='$address', `Religion`='$religion' WHERE  `Phonenumber`='$phone_number'";
...
<body>
    <div class="container">
        ...
        <form method="POST" action="updaterecord.php">
            ...
            <input type="submit" style="width: 100%;" value="Update" name="update">
        </form>
    </div>
</body>
</html>
